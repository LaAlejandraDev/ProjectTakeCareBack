...
namespace ProjectTakeCareBack.Migrations
{
    ...
    [Migration("20251130213409_ComentarioCita")]
    partial class ComentarioCita
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectTakeCareBack.Models.CitaComentario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectTakeCareBack.Models.Expediente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectTakeCareBack.Models.Cita", b =>
                {
                    ...
                    b.HasOne("ProjectTakeCareBack.Models.Expediente", "Expediente")
                        .WithMany("Citas")
            ...
            modelBuilder.Entity("ProjectTakeCareBack.Models.CitaComentario", b =>
                {
                    b.HasOne("ProjectTakeCareBack.Models.Cita", "Cita")
                        .WithOne("Comentario")
                        .HasForeignKey("ProjectTakeCareBack.Models.CitaComentario", "CitaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjectTakeCareBack.Models.Expediente", b =>
                {
                    b.HasOne("ProjectTakeCareBack.Models.Paciente", "Paciente")
                        .WithOne("Expediente")
                        .HasForeignKey("ProjectTakeCareBack.Models.Expediente", "PacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
